...
```
docker build -t recarga-celular-app .
...
psql -U postgres -d recarga_celular
...
Verifique o conteúdo da tabela recarga:
...
You can then execute your native executable with: `./target/recarga-celular-microservice-1.0.0-SNAPSHOT-runner`
